...
export function ProviderCard({ provider }: ProviderCardProps) {
  return (
    <Card
      className={`rounded-xl shadow-lg border ${COLORS.primaryBorder} bg-white w-full h-[600px] max-w-[400px] mx-auto flex flex-col font-sans transition-all duration-300 hover:shadow-xl hover:scale-[1.01] focus-within:shadow-xl focus-within:scale-[1.01]`}
