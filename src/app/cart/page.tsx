    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5E8D3] to-[#fcf5eb] flex flex-col items-center py-12 px-2">
      <div className="w-full max-w-2xl mx-auto">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-[#7C5E3C]/70 text-lg">
        ...
        {cart.length === 0 ? (
          <div className="bg-white/80 rounded-2xl shadow-lg p-10 flex flex-col items-center">
            ...
            <p className="mb-4 text-[#7C5E3C]/80">
              ...
              <ul className="divide-y divide-gray-200 max-h-64 overflow-y-auto mb-4">
                {cart.map(
                  (
                    ...
                    <li
                      key={item.id} // ✅ Utilisez item.id au lieu de idx
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <span className="font-semibold text-[#BFA181] text-lg">
                          {item.price}NOK
                        </span>
                        <button
                          onClick={() => {
                            console.log("Removing item with ID:", item.id); // Debug temporaire
